...
def is_moment_to_coverlong(index, symbol, closing_prices, resistance_value, margin, coverlong_booleans, portfolio):
    """We cover long if:
    - we own the stock
...
def go_or_cover_long(eq_symbols, eq_data, eq_supres, portfolio, requests_frequency_inmin):
    ...
    for i in range(len(eq_symbols)):
        ...
        coverlong_booleans = is_moment_to_coverlong(i, symbol, closing_prices, resistance_value, margin, coverlong_booleans, portfolio)
